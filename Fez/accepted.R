...
data[data$loan_status=="Fully Paid","profit"]<-0.99*data[data$loan_status=="Fully Paid","total_pymnt"]-data[data$loan_status=="Fully Paid","loan_amnt"]+data[data$loan_status=="Fully Paid","total_rec_late_fee"]
